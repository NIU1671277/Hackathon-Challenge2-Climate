...
if __name__ == '__main__':
    ...
    params = {
        ...
        "hourly": [
            ...
            "temperature_180m", "evapotranspiration", "et0_fao_evapotranspiration",
    ...
    hourly_temperature_80m = hourly.Variables(27).ValuesAsNumpy()
    hourly_temperature_120m = hourly.Variables(28).ValuesAsNumpy()
    hourly_temperature_180m = hourly.Variables(29).ValuesAsNumpy()
    hourly_evapotranspiration = hourly.Variables(30).ValuesAsNumpy()
    hourly_et0_fao_evapotranspiration = hourly.Variables(31).ValuesAsNumpy()
    hourly_vapour_pressure_deficit = hourly.Variables(32).ValuesAsNumpy()
    ...
    hourly_dataframe.to_json('./data/hourly_weather_data.json', orient='records', indent=4)